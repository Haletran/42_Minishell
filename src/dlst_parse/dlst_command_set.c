...
void	insert_variable_front(t_variable **head, char *key, char *value, int index)
{
	t_variable	*new_node;
...
void	insert_variable_after(t_variable *prev_node, char *key, char *value, int index)
{
	t_variable	*new_node;
...
void	insert_variable_end(t_variable **head, char *key, char *value, int index)
{
	t_variable	*new_node;
	t_variable	*tmp_node;
